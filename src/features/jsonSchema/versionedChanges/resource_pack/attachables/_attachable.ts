        ...
        changes: [
            {
                ...
                value: {
                    "description": "Définit l'Item auquel cet Attachable. \n Type: `String | Object` \n Note: Il est possible de définir une requête Molang qu doit être valide pour que l'Attachable soit associé à l'Item.",
                    "oneOf": [
                        {
                            "type": "string"
                        },
...
export const attachableSchemaTypeRP: SchemaType = {
