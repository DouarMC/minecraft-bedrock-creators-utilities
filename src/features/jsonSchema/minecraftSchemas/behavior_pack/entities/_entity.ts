...
import { commonSchemas, getCommonDefinitions } from "../../../utils/shared/commonSchemas";
import { dynamicExamplesSourceKeys, schemaEnums } from "../../../utils/shared/schemaEnums";
                ...
                description: {
                    ...
                    properties: {
                        identifier: {
                            ...
                            "x-dynamic-examples-source": dynamicExamplesSourceKeys.data_driven_entity_ids
                        },
                        runtime_identifier: {
                ...
                components: {
                    ...
                    properties: {
                        ...
                        "minecraft:ambient_sound_interval": {
                            ...
                            properties: {
                                event_name: {
                                    description: "Nom de l'événement sonore à jouer. Les événements sonores sont les clés de la propriété `events` de l'entité dans le fichier `sounds.json` du pack de ressources. Si `event_names` est défini, cette valeur sera ignorée.",
                                    default: "ambient",
                                    type: "string"
                                },
                                event_names: {
                                    description: "Liste des événements sonores à jouer avec des conditions pour les choisirs. Evaluer dans l'ordre, le premier qui est vrai est choisi. Si aucun n'est vrai, `event_name` prendra le dessus.",
                                    type: "array",
                                    items: {
                                        type: "object",
                                        properties: {
                                            ...
                                            condition: {
                                                description: "Condition Molang à remplir pour que l'événement sonore soit joué.",
                                                type: "molang"
                                            }
                                        }
                                    }
                        ...
                        "minecraft:anger_level": {
                            description: "Permet à l'entité d'accumuler de la colère envers certains ennemis et de réagir quand le seuil est atteint.",
                            type: "object",
                            properties: {
                                ...
                                on_increase_sounds: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            sound: {
                                                description: "L'événement sonore à jouer lorsque l'Entité est provoquée.",
                                                type: "string"
                                            },
                                            condition: {
                                                description: "Condition Molang à remplir pour que l'événement sonore soit joué.",
                        ...
                        "minecraft:angry": {
                            ...
                            properties: {
                                ...
                                duration_delta: {
                                    description: "Variation en secondes ajoutée à la durée de la colère. La valeur est ajoutée ou soustraite de la durée de la colère. Par exemple, si la durée est de 25 et la variation est de 5, la durée de la colère sera entre 20 et 30 secondes.",
                                    default: 0,
                                    type: "integer"
                                },
                                filters: {
                                ...
                                sound_interval: {
                                    ...
                                    oneOf: [
                                        ...
                                        },
                                        {
                                            ...
                                            properties: {
                                                range_min: {
                                                    description: "Temps minimum en secondes à attendre avant de rejouer le son de colère.",
                                                    type: "number"
                                                },
                                                range_max: {
                                                    description: "Temps maximum en secondes à attendre avant de rejouer le son de colère.",
                                                    type: "number"
                                                }
                                            }
                                        }
                        ...
                        "minecraft:annotation.break_door": {
                            description: "Oblige l'Entité à casser des portes, en supposant que des 'flags' soient configurés pour que le composant les utilise dans la navigation. Nécessite que le composant de navigation de l'entité ait le paramètre `can_break_doors` défini sur `true`.",
                            type: "object",
                            properties: {
                                break_time: {
                        ...
                        "minecraft:annotation.open_door": {
                            description: "Oblige l'Entité à ouvrir des portes, en supposant que des 'flags' soient configurés pour que le composant les utilise dans la navigation. Nécessite que le composant de navigation de l'entité ait le paramètre `can_open_doors` défini sur `true`.",
                            type: "object"
                        },
                        ...
                        "minecraft:attack": {
                            ...
                            properties: {
                                damage: {
                                    description: "Le montant de dégâts infligés par l'attaque. Note: Une valeur négative soignera l'Entité. Si un tableau est fourni, un montant de dégâts aléatoire sera choisi entre les deux valeurs.",
                                    oneOf: [
                                        {
                                            type: "integer"
                                        },
                                ...
                                effect_duration: {
                                    description: "Durée en secondes de l'effet appliqué à l'entité touchée. Possibilité de définir cette valeur sur `infinite` pour un effet permanent.",
                                    default: 0,
                                    oneOf: [
                                        {
                                            type: "number"
                        ...
                        "minecraft:block_sensor": {
                            ...
                            properties: {
                                on_break: {
                                    description: "Liste des blocs à surveiller quand ils sont cassés pour déclencher l'événement d'entité associé. Si un bloc est dans plusieurs listes, plusieurs événements se produiront.",
                                    type: "array",
                                    items: {
                                        type: "object",
                                        properties: {
                                            block_list: {
                                                description: "Liste des blocs à surveiller pour déclencher l'événement d'entité associé.",
                                                type: "array",
                                                items: {
                                                    type: "string",
                                            ...
                                            on_block_broken: {
                                                description: "L'événement d'entité à déclencher lorsque le bloc est cassé.",
                                                oneOf: [
                                                    {
                                                        type: "string"
                                                    },
                                ...
                                sources: {
                                    description: "Liste des sources de cassage blocs qui déclencheront l'événement. Si aucune n'est spécifiée, tous les blocs cassés déclencheront l'événement. Si aucun n'est spécifié, tous les blocs cassés déclencheront l'événement. Les élements de la liste sont sous la forme de filtres de conditions.",
                                    type: "array",
                                    items: {
                                        ...commonSchemas.minecraft_filter
                                    }
                            ...
                            properties: {
                                boost_items: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            item: {
                                                description: "L'item qui peut être utilisé pour booster l'Entité.",
                                                type: "string",
                                                "x-dynamic-examples-source": dynamicExamplesSourceKeys.item_ids
                                            },
                                            damage: {
                                                description: "Le montant de dégâts infligés à l'item lorsqu'il est utilisé pour booster l'Entité.",
                                                default: 1,
                                                type: "integer"
                                            },
                                            replace_item: {
                                                description: "L'item qui remplacera l'item utilisé pour booster l'Entité.",
                                                type: "string",
                                                "x-dynamic-examples-source": dynamicExamplesSourceKeys.item_ids
                                            }
                                        }
                        ...
                        "minecraft:breedable": {
                            description: "Oblige l'Entité à entrer dans l'état d'amour utilisé pour la reproduction. L'Entité doit avoir le composant `minecraft:behavior.breed` pour se reproduire.",
                            type: "object",
                            properties: {
                                allow_sitting: {
                                ...
                                environment_requirements: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            blocks: {
                                                description: "Liste des blocs proches requis pour l'accouplement.",
                                                type: "array",
                                                items: {
                                                    type: "string",
                                                    "x-dynamic-examples-source": dynamicExamplesSourceKeys.block_ids
                                            ...
                                            count: {
                                                description: "Le nombre de types de blocs requis à proximité pour l'Entité pour se reproduire.",
                                                type: "integer"
                                            },
                                            radius: {
                                                description: "Le rayon en blocs du centre de l'Entité pour rechercher les blocs requis. Borné entre 0 et 16.",
                                                type: "integer",
                                                minimum: 0,
                                                maximum: 16
                                            }
                        ...
                        "minecraft:cannot_be_attacked": {
                            description: "Empêche les entités de s'attaquer à l'Entité. Si l'Entité possède le composant `minecraft:ignore_cannot_be_attacked`, les entités qui correspondent aux filtres de ce composant peuvent toujours attaquer l'Entité.",
                            type: "object"
                        },
                        ...
                        "minecraft:color": {
                            description: "Définit la couleur principale de l'Entité. Note: Cet attribut ne fonctionne que sur les entités vanilles qui ont des valeurs de couleur prédéfinies (mouton, lama, shulker).",
                            type: "object",
                            properties: {
                                color: {
                        ...
                        "minecraft:color2": {
                            description: "Définit la couleur de la seconde texture de l'Entité. Note : Cet attribut ne fonctionne que sur les entités vanilles qui ont des valeurs de couleur prédéfinies (poisson tropical).",
                            type: "object",
                            properties: {
                                value: {
                            ...
                            properties: {
                                conditional_values: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            conditional_values: {
                                                description: "Conditions qui doivent être remplies pour que les valeurs d'optimisation soient appliquées.",
                                                ...commonSchemas.minecraft_filter
                                            },
                                            max_dropped_ticks: {
                                                description: "En relation avec la valeur d'optimisation, détermine le nombre maximum de ticks que les paquets de mise à jour spatiale peuvent être abandonnés.",
                                                default: 10,
                                                type: "integer",
                                                minimum: 0
                                            },
                                            max_optimized_distance: {
                                                description: "La distance maximale considérée lors des optimisations de bande passante. Toute valeur inférieure à la valeur maximale est interpolée pour trouver l'optimisation, et toute valeur supérieure ou égale à la valeur maximale donne une optimisation maximale.",
                                                default: 80,
                                                type: "integer"
                                            },
                                            use_motion_prediction_hints: {
                                                description: "Lorsque défini sur true, des paquets de mouvement plus petits seront envoyés pendant les intervalles de paquets abandonnés, ce qui permet d'envoyer la même quantité de paquets qu'avec des optimisations mais avec moins de données envoyées. Cela devrait être utilisé pour éviter les anomalies visuelles lorsque les entités se déplacent rapidement ou se téléportent.",
                                                default: false,
                                                type: "boolean"
                                            }
                                        }
                            ...
                            properties: {
                                hitboxes: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            height: {
                                                description: "La hauteur de la boîte de collision en blocs. Une valeur négative sera considérée comme 0.",
                                                type: "number"
                                            },
                                            width: {
                                                description: "La largeur de la boîte de collision en blocs. Une valeur négative sera considérée comme 0.",
                                                type: "number"
                                            },
                                            pivot: {
                                                description: "Le point de pivot de la boîte de collision.",
                                                type: "array",
                                                minItems: 3,
                                                maxItems: 3,
                                                items: {
                        ...
                        "minecraft:despawn": {
                            ...
                            properties: {
                                ...
                                despawn_from_distance: {
                                    ...
                                    properties: {
                                        max_distance: {
                                            description: "Distance maximale pour les règles de despawn standard pour faire disparaitre instantanément l'Entité.",
                                            default: 128,
                                            type: "integer"
                                        },
                                        min_distance: {
                                            description: "Distance minimale pour les règles de despawn standard pour essayer de faire disparaitre l'Entité.",
                                            default: 32,
                                            type: "integer"
                                        }
                                    }
                                ...
                                filters: {
                                    description: "La liste des conditions qui doivent être satisfaites pour que l'Entité despawn. Si un filtre est défini, les règles de despawn standard sont ignorées.",
                                    ...commonSchemas.minecraft_filter
                                },
                        ...
                        "minecraft:dweller": {
                            ...
                            properties: {
                                ...
                                update_interval_base: {
                                    description: "Définit la fréquence à laquelle l'Entité vérifie son statut de logement en ticks.",
                                    type: "number",
                                    minimum: 0.0
                                },
                        ...
                        "minecraft:entity_armor_equipment_slot_mapping": {
                            description: "Spécifie l'emplacement de l'armure où un item dans le deuxième slot du composant `minecraft:equippable` doit être équipé. Ceci est automatiquement appliqué à toutes les entités pour les mondes avec une version supérieure ou égale à 1.21.10. Pour les mondes plus anciens, `slot.armor.torso` sera utilisé. Il est fortement conseillé de ne pas utiliser explicitement ce composant, car aucune compatibilité ascendante ne sera fournie.",
                            type: "object",
                            properties: {
                                armor_slot: {
                        ...
                        "minecraft:entity_sensor": {
                            ...
                            properties: {
                                ...
                                relative_range: {
                                    description: "Définit si la plage est additive par rapport à la taille de l'entité. Additive signifie que la plage est ajoutée à la taille de l'entité.",
                                    default: true,
                                    type: "boolean"
                                },
                                require_all: {
                                    ...
                                    oneOf: [
                                        {
                                            ...
                                            properties: {
                                                event: {
                                                    description: "L'événement à déclencher lorsque les conditions de l'environnement correspondent aux critères de filtre donnés.",
                                                    type: "string"
                                                },
                                                filters: {
                                                    description: "L'ensemble de conditions qui doivent être satisfaites pour que l'événement soit déclenché.",
                        ...
                        "minecraft:equip_item": {
                            ...
                            properties: {
                                can_wear_armor: {
                                    description: "Définit si l'Armure équipée doit être ajoutée à l'emplacement d'armure ou à l'emplacement de main.",
                                    type: "boolean"
                                },
                                excluded_items: {
                            ...
                            properties: {
                                slot_drop_chance: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            slot: {
                                                description: "Le slot de l'équipement.",
                                                type: "string",
                                                enum: [
                                                    "slot.weapon.mainhand", "slot.weapon.offhand", "slot.armor.chest", "slot.armor.feet", "slot.armor.legs", "slot.armor.head"
                                                ]
                                            },
                                            drop_chance: {
                                                description: "Définit la chance de laisser tomber un item équipé de ce slot.",
                                                type: "number",
                                                minimum: 0.0,
                                                maximum: 1.0
                                            }
                            ...
                            properties: {
                                slots: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            accepted_items: {
                                                description: "Liste des items qui peuvent être équipés dans ce slot.",
                                                type: "array",
                                                items: {
                                                    type: "string",
                                                    "x-dynamic-examples-source": dynamicExamplesSourceKeys.item_ids
                                            ...
                                            interact_text: {
                                                "x-localized": true,
                                                description: "Texte à afficher lors de l'interaction avec l'Entité pour équiper l'item.",
                                                type: "string"
                                            },
                                            item: {
                                                description: "Identifiant de l'item qui peut être équipé pour le slot.",
                                                type: "string",
                                                "x-dynamic-examples-source": dynamicExamplesSourceKeys.item_ids
                                            },
                                            on_equip: {
                                                description: "Evénement à executer lorsque l'item est équipé.",
                                                oneOf: [
                                                    {
                                                        type: "string"
                                                    },
                                            ...
                                            on_unequip: {
                                                description: "Evénement à executer lorsque l'item est déséquipé.",
                                                oneOf: [
                                                    {
                                                        type: "string"
                                                    },
                                            ...
                                            slot: {
                                                description: "Le numero de slot de ce slot.",
                                                default: 0,
                                                type: "integer"
                                            }
                                        }
                        ...
                        "minecraft:explode": {
                            ...
                            properties: {
                                ...
                                sound_effect: {
                                    description: "Le nom de l'effet sonore à jouer lorsque l'explosion se produit. Les sons sont dans le fichier `sounds.json` dans `individual_event_sounds`.",
                                    default: "explode",
                                    type: "string"
                                },
                                toggles_blocks: {
                            ...
                            properties: {
                                genes: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            allele_range: {
                                                description: "La plage de valeurs d'allèles pour ce gène. Les valeurs d'allèles sont des entiers positifs.",
                                                type: "object",
                                                properties: {
                                                    range_max: {
                                                        description: "La valeur maximale de l'allèle pour ce gène.",
                                                        default: 0,
                                                        type: "integer"
                                                    },
                                                    range_min: {
                                                        description: "La valeur minimale de l'allèle pour ce gène.",
                                                        default: 0,
                                                        type: "integer"
                                                    }
                                                }
                                            ...
                                            genetic_variants: {
                                                description: "La liste des variantes génétiques pour ce gène. Ils vérifient les combinaisons d'allèles particulières et déclenchent des événements lorsque toutes sont satisfaites.",
                                                type: "array",
                                                items: {
                                                    type: "object",
                                                    properties: {
                                                        birth_event: {
                                                            description: "Evénement à déclencher lorsque l'Entité est créée et que les conditions d'allèle sont remplies.",
                                                            oneOf: [
                                                                {
                                                                    type: "string"
                                                                },
                                                        ...
                                                        both_allele: {
                                                            description: "Si cette valeur est non négative, comparez les allèles principaux et cachés de l'Entité avec cette valeur pour une correspondance avec les deux. Peut également être une plage d'entiers.",
                                                            default: -1,
                                                            oneOf: [
                                                                {
                                                                    type: "integer"
                                                        ...
                                                        either_allele: {
                                                            description: "Si cette valeur est non négative, comparez les allèles principaux et cachés de l'Entité avec cette valeur pour une correspondance avec l'un ou l'autre. Peut également être une plage d'entiers.",
                                                            default: -1,
                                                            oneOf: [
                                                                {
                                                                    type: "integer"
                                                        ...
                                                        hidden_allele: {
                                                            description: "Si cette valeur est non négative, comparez l'allèle caché de l'Entité avec cette valeur pour une correspondance. Peut également être une plage d'entiers.",
                                                            default: -1,
                                                            oneOf: [
                                                                {
                                                                    type: "integer"
                                                        ...
                                                        main_allele: {
                                                            description: "Si cette valeur est non négative, comparez l'allèle principal de l'Entité avec cette valeur pour une correspondance. Peut également être une plage d'entiers.",
                                                            default: -1,
                                                            oneOf: [
                                                                {
                                                                    type: "integer"
                                                        ...
                                                        mutation_rate: {
                                                            description: "Si cette valeur est non négative, remplacez la valeur de l'allèle principal de l'Entité par une valeur aléatoire entre 0 et la valeur de cette propriété. Les valeurs non négatives supérieures à 1 seront les mêmes que la valeur 1.",
                                                            default: -1,
                                                            type: "number"
                                                        }
                                                    }
                        ...
                        "minecraft:giveable": {
                            ...
                            properties: {
                                triggers: {
                                    ...
                                    properties: {
                                        cooldown: {
                                            description: "Un temps de recharge en secondes pour empêcher le spam des interactions.",
                                            default: 0.0,
                                            type: "number"
                                        },
                                        items: {
                                            description: "La liste des items qui peuvent être utilisés pour déclencher l'événement.",
                                            type: "array",
                                            items: {
                                                type: "string",
                                                "x-dynamic-examples-source": dynamicExamplesSourceKeys.item_ids
                                        ...
                                        on_give: {
                                            description: "Evénement à déclencher lorsque l'item est donné à l'Entité.",
                                            oneOf: [
                                                {
                                                    type: "string"
                                                },
                            ...
                            properties: {
                                ...
                                items: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            effects: {
                                                description: "Liste des effets à appliquer à l'Entité lorsqu'elle est nourrie avec cet item.",
                                                type: "array",
                                                items: {
                                                    type: "object",
                                                    required: ["name"],
                                                    properties: {
                                                        name: {
                                                            description: "Le nom de l'effet à appliquer à l'Entité.",
                                                            type: "string",
                                                            "x-dynamic-examples-source": dynamicExamplesSourceKeys.effect_ids
                                                        },
                                                        chance: {
                                                            description: "La chance que l'effet soit appliqué à l'Entité.",
                                                            default: 1.0,
                                                            type: "number"
                                                        },
                                                        duration: {
                                                        ...
                                                        amplifier: {
                                                            description: "Le niveau de l'effet à appliquer à l'Entité.",
                                                            default: 0,
                                                            type: "integer"
                                                        }
                                                    }
                                            ...
                                            heal_amount: {
                                                description: "Le montant de santé que l'Entité gagne lorsqu'elle est nourrie avec cet item.",
                                                default: 1,
                                                type: "integer"
                                            },
                                            item: {
                        ...
                        "minecraft:health": {
                            ...
                            properties: {
                                ...
                                value: {
                                    description: "La quantité de santé que l'Entité a lorsqu'elle est invoquée. Si la valeur est un objet, la santé de l'Entité sera aléatoire entre les valeurs min et max.",
                                    oneOf: [
                                        {
                                            type: "integer"
                                        },
                        ...
                        "minecraft:heartbeat": {
                            ...
                            properties: {
                                interval: {
                                    description: "Une expression Molang définissant l'intervalle inter-battement en secondes. Une valeur de zéro ou moins signifie pas de battement de coeur. Une valeur de zéro ou moins signifie pas de battement de coeur.",
                                    default: 1.0,
                                    type: "molang"
                                },
                                sound_event: {
                        ...
                        "minecraft:home": {
                            ...
                            properties: {
                                ...
                                restriction_type: {
                                    description:
                                    "Définit comment l'Entité sera restreinte à sa position de maison." +
                                    "\n\n- `none`: aucune restriction" +
                                    "\n\n- `random_movement`: mouvement aléatoire restreint autour de la maison" +
                                    "\n\n- `all_movement`: tout mouvement restreint autour de la maison",
                                    type: "string",
                        ...
                        "minecraft:horse.jump_strength": {
                            ...
                            properties: {
                                value: {
                                    description: "Valeur de la force de saut que l'Entité a lorsqu'elle est invoquée. Si la valeur est un objet, la force de saut de l'Entité sera aléatoire entre les valeurs min et max.",
                                    oneOf: [
                                        {
                                            type: "integer"
                                        },
                                        {
                                            ...
                                            properties: {
                                                range_min: {
                                                    description: "La force de saut minimale que l'Entité peut avoir.",
                                                    type: "integer"
                                                },
                                                range_max: {
                                                    description: "La force de saut maximale que l'Entité peut avoir.",
                                                    type: "integer"
                                                }
                                            }
                                        }
                            ...
                            properties: {
                                damage_conditions: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            cause: {
                                                description: "Le type de dégâts qui peuvent être infligés à l'Entité. Plusieurs armures et sorts utilisent ce champ pour déterminer si l'Entité est immunisée.",
                                                type: "string",
                                                enum: schemaEnums.entity_damage_causes
                                            },
                                            damage_per_tick: {
                                                description: "Montant de dégâts infligés à l'Entité par tick.",
                                                default: 1,
                                                type: "integer"
                                            },
                                            filters: {
                                                description: "Liste des conditions qui doivent être satisfaites pour que l'Entité prenne des dégâts.",
                                                ...commonSchemas.minecraft_filter
                                            }
                                        }
                                    }
                        ...
                        "minecraft:ignore_cannot_be_attacked": {
                            ...
                            properties: {
                                filters: {
                                    description: "Définit quelles entités peuvent attaquer l'Entité. Si cette propriété n'est pas définie, toutes les attaques sont autorisées.",
                                    ...commonSchemas.minecraft_filter
                                }
                            }
                        },
                            ...
                            properties: {
                                block_list: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            block: {
                                                description: "Le nom du bloc à surveiller.",
                                                oneOf: [
                                                    {
                                                        type: "string",
                                                        "x-dynamic-examples-source": dynamicExamplesSourceKeys.block_ids
                                            ...
                                            entered_block_event: {
                                                description: "Evénement à déclencher lorsque l'Entité entre dans le bloc.",
                                                oneOf: [
                                                    {
                                                        type: "string"
                                                    },
                                            ...
                                            exited_block_event: {
                                                description: "Evénement à déclencher lorsque l'Entité sort du bloc.",
                                                oneOf: [
                                                    {
                                                        type: "string"
                                                    },
                                ...
                                interactions: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            ...
                                            on_interact: {
                                                description: "Evenement à déclencher lorsqu'une interaction réussie se produit. Si le filtres sont validés, les actions des autres propriété comme `give_item`, `play_sounds`, etc. seront également exécutées.",
                                                oneOf: [
                                                    {
                                                        type: "string"
                                                    },
                                            ...
                                            swing: {
                                                description: "Si `true`, le joueur fera l'animation de 'swing' lorsqu'il interagit avec cette Entité.",
                                                default: false,
                                                type: "boolean"
                                            },
                                            take_item: {
                        ...
                        "minecraft:inventory": {
                            ...
                            properties: {
                                ...
                                container_type: {
                                    ...
                                    type: "string",
                                    enum: [
                                        "horse", "minecart_chest", "chest_boat", "minecart_hopper", "inventory", "container", "hopper", "none"
                                    ]
                                },
                                inventory_size: {
                        ...
                        "minecraft:is_baby": {
                            description: "Définit que l'Entité est un bébé. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        "minecraft:is_charged": {
                            description: "Définit si l'Entité est chargée. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        "minecraft:is_chested": {
                            description: "Définit que l'Entité porte actuellement un coffre. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        ...
                        "minecraft:is_ignited": {
                            description: "Définit si l'Entité est enflammée. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        "minecraft:is_illager_captain": {
                            description: "Définit si l'Entité est un capitaine pillard. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        "minecraft:is_pregnant": {
                            description: "Définit si l'Entité est enceinte. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        "minecraft:is_saddled": {
                            description: "Définit si l'Entité est sellée. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        ...
                        "minecraft:is_sheared": {
                            description: "Définit si l'Entité a été tondue. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        ...
                        "minecraft:is_stunned": {
                            description: "Définit si l'Entité est étourdie. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                        "minecraft:is_tamed": {
                            description: "Définit si l'Entité est apprivoisée. Ce composant est utilisé pour des requêtes Molang ou de filtres",
                            type: "object"
                        },
                            ...
                            properties: {
                                ...
                                presets: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            filter: {
                                                description: "Définit les conditions qui doivent être satisfaites pour que le préréglage soit utilisé.",
                                                ...commonSchemas.minecraft_filter
                                            },
                                            soft_distance: {
                                            ...
                                            spring_type: {
                                                description:
                                                "Définit le type de ressort qui tire l'entité vers son détenteur de laisse." +
                                                 "\n\n- `bouncy`: Simule un ressort très élastique qui n'atteint jamais un équilibre si l'entité attachée est suspendue dans les airs." +
                                                 "\n\n- `dampened`: Simule un ressort amorti attaché à l'avant de la collision de l'entité attachée. Il atteint un équilibre si l'entité est suspendue dans les airs et s'aligne avec la direction du mouvement." +
                                                 "\n\n- `quad_dampened`: Simule quatre ressorts amortis connectés au centre de chaque côté des collisions des entités. Il atteint un équilibre si l'entité est suspendue dans les airs et s'aligne progressivement avec le détenteur de la laisse au fil du temps.",
                                                default: "dampened",
                                                type: "string",
                                                enum: ["bouncy", "dampened", "quad_dampened"]
                                            },
                                            rotation_adjustment: {
                                                description: "Ajuste la rotation à laquelle l'entité atteint l'équilibre, lorsque 'spring_type' est défini sur 'dampened' ou 'quad_dampened'.",
                                                default: 0,
                                                type: "number"
                                            }
                                        }
                            ...
                            properties: {
                                ...
                                look_at_locations: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            location: {
                                                description: "Le nom de l'emplacement sur l'Entité propriétaire.",
                                                type: "string",
                                                enum: [
                                                    "head", "body", "feet"
                                                ]
                                            ...
                                            vertical_offset: {
                                                description: "Un décalage vertical en blocs à appliquer à l'emplacement.",
                                                default: 0.0,
                                                type: "number"
                                            }
                                        }
                                ...
                                set_target: {
                                    description:
                                    "Définit si et comment l'Entité propriétaire définira les entités qui la regardent comme ses cibles de combat." +
                                    "\n\n- `never`: les entités regardant ne sont jamais définies comme cibles, mais des événements sont émis." +
                                    "\n\n- `once_and_stop_scanning`: la première entité regardant détectée est définie comme cible. La numérisation et l'émission d'événements sont suspendues jusqu'à ce que l'Entité propriétaire ait une cible." +
                                    "\n\n- `once_and_keep_scanning`: la première entité regardant détectée est définie comme cible. La numérisation et l'émission d'événements se poursuivent.",
                        ...
                        "minecraft:managed_wandering_trader": {
                            description: "Gère la capacité de l'Entité à commercer. Ce composant est seulement utilisable pour les marchands ambulants.",
                            type: "object"
                        },
                        "minecraft:mark_variant": {
                            description: "Définit la variante de l'Entité. Ce composant nécessite que l'Entité soit configurée pour utiliser des variantes avec le composant de propriété minecraft:variant.",
                            type: "object",
                            properties: {
                                value: {
                        ...
                        "minecraft:movement.dolphin": {
                            description: "Force une Entité à se déplacer comme un dauphin. Ce composant n'est pas utilisé dans le jeu.",
                            type: "object"
                        },
                        ...
                        "minecraft:movement.jump": {
                            description: "Se déplace en sautant. Pour pouvoir suivre des cibles, cette entité doit avoir minecraft:behavior.slime_attack, sinon l'Entité sautera dans la direction dans laquelle elle regarde.",
                            type: "object",
                            properties: {
                                jump_delay: {
                        ...
                        "minecraft:nameable": {
                            ...
                            properties: {
                                ...
                                name_actions: {
                                    ...
                                    properties: {
                                        name_filter: {
                                            description: "Liste de noms spéciaux qui déclencheront les évenements définis.",
                                            type: "string"
                                        },
                                        on_named: {
                                            description: "Evenement à déclencher lorsque l'Entité acquiert un nom spécial.",
                                            oneOf: [
                                                {
                                                    type: "string"
                                                },
                        ...
                        "minecraft:npc": {
                            ...
                            properties: {
                                npc_data: {
                                    ...
                                    properties: {
                                        portrait_offsets: {
                                            description: "Définit les décalages du portrait de l'Entité.",
                                            type: "object",
                                            properties: {
                                                translate: {
                                                    description: "Définit les décalages de translation du portrait de l'Entité.",
                                                    type: "array",
                                                    items: {
                                                        type: "number"
                                                    }
                                                ...
                                                scale: {
                                                    description: "Définit l'échelle du portrait de l'Entité.",
                                                    type: "array",
                                                    items: {
                                                        type: "number"
                                                    }
                                        ...
                                        picker_offsets: {
                                            description: "Définit les décalages du sélecteur de l'Entité.",
                                            type: "object",
                                            properties: {
                                                translate: {
                                                    description: "Définit les décalages de translation du sélecteur de l'Entité.",
                                                    type: "array",
                                                    items: {
                                                        type: "number"
                                                    }
                                                ...
                                                scale: {
                                                    description: "Définit l'échelle du sélecteur de l'Entité.",
                                                    type: "array",
                                                    items: {
                                                        type: "number"
                                                    }
                                        ...
                                        skin_list: {
                                            description: "La liste des skins du NPC. Chaque élément de cette liste contient unr propéiété 'variant' qui modifie la variante de l'Entité comme le composant 'minecraft:variant'.",
                                            type: "array",
                                            items: {
                                                type: "object",
                                                properties: {
                                                    variant: {
                                                        description: "Définit la variante de l'Entité.",
                                                        type: "integer"
                                                    }
                                                }
                                            }
                        ...
                        "minecraft:on_start_landing": {
                            description: "Ajoute un déclencheur d'événement lorsque l'entité commence à atterrir. Note: minecraft:on_start_landing ne peut être utilisé que par l'entité ender_dragon.",
                            ...commonSchemas.entity_event_trigger
                        },
                        "minecraft:on_start_takeoff": {
                            description: "Ajoute un déclencheur d'événement lorsque l'entité commence à décoller. Note: minecraft:on_start_takeoff ne peut être utilisé que par l'entité ender_dragon.",
                            ...commonSchemas.entity_event_trigger
                        },
                        "minecraft:on_target_acquired": {
                            description: "Ajoute un déclencheur d'événement lorsqu'une entité acquiert une cible. Ce composant nécessite que l'entité peut avoir une cible pour fonctionner.",
                            ...commonSchemas.minecraft_filter
                        },
                        "minecraft:on_target_escape": {
                            description: "Ajoute un déclencheur d'événement lorsqu'une entité perd sa cible. Ce composant nécessite que l'entité peut avoir une cible pour fonctionner.",
                            ...commonSchemas.minecraft_filter
                        },
                        "minecraft:on_wake_with_owner": {
                            description: "Ajoute un déclencheur d'événement lorsque le propriétaire de l'entité se réveille après avoir dormi avec l'entité. Note: minecraft:on_wake_with_owner nécessite qu'un joueur soit étiqueté comme propriétaire de l'entité, via le dressage ou la commande console.",
                            ...commonSchemas.entity_event_trigger
                        },
                            ...
                            properties: {
                                ...
                                preferred_path_blocks: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            cost: {
                                                description: "Le coût associé à ce bloc.",
                                                type: "number"
                                            },
                                            blocks: {
                                                description: "La liste des blocs.",
                                                type: "array",
                                                items: {
                                                    type: "string",
                                                    "x-dynamic-examples-source": dynamicExamplesSourceKeys.block_ids
                        ...
                        "minecraft:projectile": {
                            ...
                            properties: {
                                anchor: {
                                    description:
                                    "Permet de choisir un point d'ancrage pour lequel le projectile est tiré." +
                                    "\n\n- `0` = Point d'origine" +
                                    "\n\n- `1` = Hauteur des yeux" +
                                    "\n\n- `2` = Milieu ou hauteur du corps",
                                    default: 0,
                                    type: "integer",
                                    enum: [0, 1, 2]
                                },
                                ...
                                on_hit: {
                                    ...
                                    properties: {
                                        catch_fire: {
                                            description: "Détèrmine si l'entité touchée est en feu.",
                                            default: false,
                                            type: "boolean"
                                        },
                                        definition_event: {
                                            description: "L'événement à déclencher lorsqu'un projectile touche quelque chose.",
                                            type: "object",
                                            properties: {
                                                affect_projectile: {
                                                    description: "Le projectile sera affecté par cet événement.",
                                                    default: false,
                                                    type: "boolean"
                                                },
                                                affect_shooter: {
                                                    description: "Le tireur sera affecté par cet événement.",
                                                    default: false,
                                                    type: "boolean"
                                                },
                                                affect_splash_area: {
                                                    description: "Toutes les entités dans la zone de l'explosion seront affectées par cet événement.",
                                                    default: false,
                                                    type: "boolean"
                                                },
                                                splash_area: {
                                                    description: "La zone d'éclaboussure qui sera affectée.",
                                                    default: 0.0,
                                                    type: "number"
                                                },
                                                affect_target: {
                                                    description: "La cible sera affectée par cet événement.",
                                                    default: false,
                                                    type: "boolean"
                                                },
                                                event_trigger: {
                                        ...
                                        douse_fire: {
                                            description: "Si la cible est en feu, définit si le feu doit être éteint.",
                                            default: false,
                                            type: "boolean"
                                        },
                                        freeze_on_hit: {
                                            description: "Définit les propriétés de gel à l'impact.",
                                            type: "object",
                                            properties: {
                                                size: {
                                                    description: "La taille de la zone gelée.",
                                                    type: "number"
                                                },
                                                shape: {
                                                    description: "La forme de la zone gelée.",
                                                    type: "string",
                                                    enum: ["sphere", "cube"]
                                                },
                                                snap_to_block: {
                                        ...
                                        grant_xp: {
                                            description: "Accorde des XP en cas de coup. Possède minXP pour le minimum d'XP accordé, maxXp pour le maximum ou simplement des propriétés XP fixes.",
                                            type: "object",
                                            properties: {
                                                minXP: {
                                                    description: "Le minimum d'XP accordé.",
                                                    type: "integer"
                                                },
                                                maxXP: {
                                                    description: "Le maximum d'XP accordé.",
                                                    type: "integer"
                                                },
                                                xp: {
                                                    description: "Le montant constant d'XP à donner. Lorsqu'il est défini, il sera utilisé à la place des valeurs min et max.",
                                                    type: "integer"
                                                }
                                            }
                                        },
                                        hurt_owner: {
                                            description: "Détermine si le propriétaire de l'entité est blessé lorsqu'il est touché.",
                                            type: "object",
                                            properties: {
                                                owner_damage: {
                                                    type: "integer"
                                        ...
                                        ignite: {
                                            description: "Détermine si un feu peut être allumé sur l'entité touchée.",
                                            default: false,
                                            type: "boolean"
                                        },
                                        impact_damage: {
                                            ...
                                            properties: {
                                                ...
                                                channeling: {
                                                    description: "Définit si la foudre peut être canalisée à travers l'arme.",
                                                    default: true,
                                                    type: "boolean"
                                                },
                                                damage: {
                                                    description: "Les dégâts infligés à l'entité touchée.",
                                                    default: 1,
                                                    type: "integer"
                                                },
                                                destroy_on_hit: {
                                                    description: "Définit si le projectile est supprimé lors de l'impact.",
                                                    default: false,
                                                    type: "boolean"
                                                },
                                                destroy_on_hit_requires_damage: {
                                                    description: "Définit si le projectile doit causer des dégâts pour être détruit lors de l'impact.",
                                                    default: true,
                                                    type: "boolean"
                                                },
                                                filter: {
                                                    description: "L'identifiant de l'entité qui peut être touchée par le projectile.",
                                                    type: "string",
                                                    "x-dynamic-examples-source": dynamicExamplesSourceKeys.entity_ids
                                                },
                                                knockback: {
                                                    description: "Définit si le projectile doit repousser l'entité touchée.",
                                                    default: true,
                                                    type: "boolean"
                                                },
                                                max_critical_damage: {
                                                    description: "Dégat critique maximum.",
                                                    type: "integer"
                                                },
                                                min_critical_damage: {
                                                    description: "Dégât critique minimum.",
                                                    default: 0,
                                                    type: "integer"
                                                },
                                                power_multiplier: {
                                        ...
                                        mob_effect: {
                                            description: "La cible reçoit un effet de mob.",
                                            type: "object",
                                            properties: {
                                                amplifier: {
                                        ...
                                        on_fire_time: {
                                            description: "Le temps pendant lequel la cible est en feu.",
                                            default: 0.0,
                                            type: "number"
                                        },
                                        particle_on_hit: {
                                            description: "Les particules qui apparaissent lorsqu'un projectile touche quelque chose.",
                                            type: "object",
                                            properties: {
                                                particle_type: {
                                                    description: "L'ID de la particule à emettre.",
                                                    type: "string"
                                                },
                                                on_other_hit: {
                                                    description: "Définit si génère des particules à tout autre coup.",
                                                    default: false,
                                                    type: "boolean"
                                                },
                                                on_entity_hit: {
                                                    description: "Définit si génère des particules à tout coup sur une entité.",
                                                    default: false,
                                                    type: "boolean"
                                                },
                                                num_particles: {
                                                    description: "Le nombre de particules à générer.",
                                                    default: 6,
                                                    type: "integer"
                                                },
                                                particle_item_name: {
                                                    description: "Sélectionne le nom de la particule à utiliser si les filtres sont valides.",
                                                    type: "object",
                                                    additionalProperties: {
                                                        ...commonSchemas.minecraft_filter
                                                    }
                                        ...
                                        potion_effect: {
                                            description: "Définit l'effet de la flèche qui s'appliquera à l'entité touchée.",
                                            default: -1,
                                            type: "integer"
                                        },
                                        remove_on_hit: {
                                            description: "Supprime le projectile.",
                                            type: "object"
                                        },
                                        spawn_aoe_cloud: {
                                            description: "La potion crée un nuage d'effet de zone.",
                                            type: "object",
                                            properties: {
                                                affect_owner: {
                                                    description: "Détermine si le tireur est affecté par le nuage.",
                                                    default: true,
                                                    type: "boolean"
                                                },
                                                color: {
                                                    description: "Couleur du nuage sous format RGB.",
                                                    type: "array",
                                                    minItems: 3,
                                                    maxItems: 3,
                                                    items: {
                                                ...
                                                duration: {
                                                    description: "Combien de temps la particule est émise.",
                                                    default: 0,
                                                    type: "integer"
                                                },
                                                particle: {
                                                    description: "L'émetteur de particules.",
                                                    default: 0,
                                                    type: "integer"
                                                },
                                                potion: {
                                                    description: "L'ID de la potion.",
                                                    default: -1,
                                                    type: "integer"
                                                },
                                                radius: {
                                                    description: "Définit la zone d'effet du nuage.",
                                                    default: 0,
                                                    type: "number"
                                                },
                                                radius_on_use: {
                                                    description: "Définit la zone d'effet du nuage lorsqu'il est utilisé.",
                                                    default: -1,
                                                    type: "number"
                                                },
                                                reapplication_delay: {
                                                    description: "Delai avant que la potion puisse affecter la zone à nouveau.",
                                                    default: 0,
                                                    type: "integer"
                                                }
                                            }
                                        ...
                                        spawn_chance: {
                                            description: "Contient des informations sur la chance de faire apparaître une entité lorsqu'elle est touchée.",
                                            type: "object",
                                            properties: {
                                                first_spawn_count: {
                                                    description: "Le nombre d'entités à faire apparaître.",
                                                    default: 0,
                                                    type: "integer"
                                                },
                                                first_spawn_percent_chance: {
                                                    description: "La chance qu'une entité apparaisse lorsqu'elle est touchée.",
                                                    default: 0,
                                                    type: "number"
                                                },
                                                on_spawn: {
                                                    description: "Le ou les événements à déclencher lorsqu'une entité apparaît.",
                                                    type: "array",
                                                    items: {
                                                        oneOf: [
                                                            {
                                                ...
                                                second_spawn_chance: {
                                                    description: "La chance qu'une deuxième entité apparaisse lorsqu'elle est touchée.",
                                                    default: 32,
                                                    type: "number"
                                                },
                                                second_spawn_count: {
                                                    description: "Le nombre d'entités à faire apparaître lors de la deuxième apparition.",
                                                    default: 0,
                                                    type: "integer"
                                                },
                                                spawn_definition: {
                                                    description: "Définit les entités à faire apparaître.",
                                                    type: "string",
                                                    "x-dynamic-examples-source": dynamicExamplesSourceKeys.entity_ids
                                                },
                                                spawn_baby: {
                                                    description: "Définit si l'entité apparue est un bébé.",
                                                    default: false,
                                                    type: "boolean"
                                                }
                                            }
                                        ...
                                        stick_in_ground: {
                                            description: "Définit si l'objet reste dans le sol et contient le paramètre shake_time pour déterminer combien de temps il va trembler.",
                                            type: "object",
                                            properties: {
                                                shake_time: {
                                                    description: "Le temps que l'objet reste dans le sol.",
                                                    type: "number"
                                                }
                                            }
                                        },
                                        teleport_owner: {
                                            description: "Définit si le propriétaire de l'entité est téléporté lorsqu'il est touché.",
                                            default: false,
                                            type: "boolean"
                                        },
                                        thrown_potion_effect: {
                                            description: "Crée une zone d'effet pour les effets causés par une potion lancée.",
                                            default: {},
                                            type: "object"
                                        },
                                        wind_burst_on_hit: {
                                            description: "Crée une charge de vent au momoent et au lieu de l'impact du Projectile.",
                                            type: "object"
                                        }
                                    }
                                },
                        ...
                        "minecraft:rail_movement": {
                            description: "Définit le mouvement de l'Entité sur les rails. Une Entité avec ce composant ne peut se déplacer que sur les rails.",
                            type: "object",
                            properties: {
                                max_speed: {
                            ...
                            properties: {
                                ...
                                reaction_choices: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            weight: {
                                                description: "Le poids de cette réponse.",
                                                type: "number"
                                            },
                                            value: {
                                                description: "La réponse à l'attaque au corps à corps bloquée.",
                                                oneOf: [
                                                    {
                                                        type: "string"
                                                    },
                        ...
                        "minecraft:remove_in_peaceful": {
                            description: "Définit que l'Entité ne peut pas exister en mode pacifique.",
                            type: "object"
                        },
                        "minecraft:renders_when_invisible": {
                            description: "Définit que l'Entité sera affiché même s'il est invisible. Le comportement du rendu peut être spécifié dans le fichier client de l'Entité.",
                            type: "object"
                        },
                        "minecraft:rideable": {
                            ...
                            properties: {
                                controlling_seat: {
                                    description: "Le siège qui désigne le conducteur de l'entité. Cela n'est observé que par les styles de monture de cheval/bateau ; les chariots/entités avec 'minecraft:behavior.controlled_by_player' donnent le contrôle à n'importe quel joueur dans n'importe quel siège.",
                                    default: 0,
                                    type: "integer"
                                },
                                ...
                                dismount_mode: {
                                    description:
                                    "Définit où les chevaucheurs sont placés lorsqu'ils descendent de l'Entité." +
                                    "\n\n- `default`: les chevaucheurs sont placés sur une position au sol valide autour de l'Entité ou au centre de la boite de collision si aucune position est trouvée." +
                                    "\n\n- `on_top_center`: les chevaucheurs sont placés au centre en haut de la boite de collision de l'Entité.",
                                    default: "default",
                                    type: "string",
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            camera_relax_distance_smoothing: {
                                                description: "Ajoute l'élasticité au mouvement de la caméra lorsqu'elle revient à son rayon après avoir été poussée vers le joueur par un obstacle.",
                                                type: "number",
                                                minimum: 1.0,
                                                maximum: 32.0
                                            },
                                            lock_rider_rotation: {
                                                description: "Angle en degrés que le cavalier est autorisé à tourner lorsqu'il monte cette entité. Omettre cette propriété pour aucune limite.",
                                                default: 181,
                                                type: "number"
                                            },
                                            max_rider_count: {
                                                description: "Définit le nombre maximum de cavaliers qui peuvent chevaucher cette entité pour que ce siège soit valide.",
                                                default: 0,
                                                type: "integer"
                                            },
                                            min_rider_count: {
                                                description: "Définit le nombre minimum de cavaliers qui peuvent chevaucher cette entité pour que ce siège soit valide.",
                                                default: 0,
                                                type: "integer"
                                            },
                                            position: {
                                                description: "La position du siège par rapport à l'entité.",
                                                default: [0, 0, 0],
                                                type: "array",
                                                minItems: 3,
                                                maxItems: 3,
                                            ...
                                            rotate_rider_by: {
                                                description: "Décalage pour faire tourner les cavaliers.",
                                                default: 0,
                                                type: "molang"
                                            },
                                            third_person_camera_radius: {
                                                description: "Permet de définir un rayon différent de caméra pour la caméra 3ème personne ou 3ème personne avant.",
                                                type: "number",
                                                minimum: 1.0,
                                                maximum: 64.0
                                            }
                            ...
                            properties: {
                                ...
                                items: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            admire: {
                                                description: "Définit si l'entité admirera l'item après l'avoir ramassé en le regardant. Pour que cela se produise, l'entité doit avoir un composant Admire et un objectif Admire.",
                                                default: false,
                                                type: "boolean"
                                            },
                                            barter: {
                                                description: "Définit si l'entité marchandera l'item après l'avoir ramassé. Pour que cela se produise, l'entité doit avoir un composant Barter et un objectif Barter.",
                                                default: false,
                                                type: "boolean"
                                            },
                                            consume_item: {
                                                description: "Détermine si l'entité consommera l'item ou non.",
                                                default: false,
                                                type: "boolean"
                                            },
                                            craft_into: {
                                            ...
                                            pickup_limit: {
                                                description: "Nombre maximum d'items que l'Entité peut ramasser.",
                                                type: "integer"
                                            },
                                            pickup_only: {
                                                description: "Détermine si l'entité peut seulement ramasser l'item et ne pas le laisser tomber.",
                                                default: false,
                                                type: "boolean"
                                            },
                                            priority: {
                                                description: "Priorise les items que l'entité préfère. 0 est la priorité la plus élevée.",
                                                type: "integer"
                                            },
                                            stored_in_inventory: {
                                                description: "Détermine si l'entité essaiera de mettre l'item dans son inventaire si elle a le composant d'inventaire et si elle ne peut pas l'équiper.",
                                                type: "boolean"
                                            },
                                            surplus_amount: {
                                                description: "Nombre d'items supplémentaires que l'Entité veut partager.",
                                ...
                                singular_pickup: {
                                    description: "Contrôle si l'entité peut ramasser plus d'un item à la fois.",
                                    default: false,
                                    type: "boolean"
                                }
                            }
                        ...
                        "minecraft:shooter": {
                            description: "Définit le comportement de l'attaque à distance de l'entité. Le composant 'minecraft:behavior.ranged_attack' utilise ce composant pour déterminer quels projectiles tirer.",
                            type: "object",
                            properties: {
                                aux_val: {
                                ...
                                def: {
                                    description: "Définit l'entité projectile à utiliser pour l'attaque à distance. L'entité doit avoir un composant 'minecraft:projectile'.",
                                    type: "string",
                                    "x-dynamic-examples-source": dynamicExamplesSourceKeys.entity_ids
                                },
                                magic: {
                                ...
                                power: {
                                    description: "Velocité à laquelle les projectiles sont tirés. Une puissance de 0 sera écrasée par la puissance de lancer de projectile par défaut.",
                                    default: 0.0,
                                    type: "number"
                                },
                                projectiles: {
                        ...
                        "minecraft:skin_id": {
                            description: "Définit l'ID du skin de l'entité. Peut être utilisé pour différencier les skins, comme les skins de base pour les villageois. Note: minecraft:skin_id nécessite plusieurs ensembles de textures pour être configuré pour l'entité.",
                            type: "object",
                            properties: {
                                value: {
                                ...
                                entities: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            ...
                                            min_wait_time: {
                                                description: "Le temps minimum aléatoire en secondes à attendre avant de générer l'entité.",
                                                default: 300,
                                                type: "integer"
                                            },
                                            num_to_spawn: {
                                                description: "Le nombre d'entités à générer.",
                                                default: 1,
                                                type: "integer"
                                            },
                                            should_leash: {
                                                description: "Si vrai, l'entité générée sera attachée à l'entité parente.",
                                                default: false,
                                                type: "boolean"
                                            },
                                            single_use: {
                                                description: "Définit si ce composant ne fera apparaître l'entité spécifiée qu'une seule fois.",
                                                default: false,
                                                type: "boolean"
                                            },
                                            spawn_entity: {
                                            ...
                                            spawn_sound: {
                                                description: "Identifiant de l'effet sonore à jouer lorsque l'entité est générée.",
                                                default: "plop",
                                                type: "string"
                                            }
                                        }
                                ...
                                add_effects: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            ...
                                            amplifier: {
                                                description: "Le niveau de l'effet.",
                                                default: 0,
                                                type: "integer"
                                            },
                                            ambient: {
                                                description: "Définit si les particules de l'effet sont ambiantes.",
                                                default: false,
                                                type: "boolean"
                                            },
                                            visible: {
                                                description: "Définit si les particules sont visibles.",
                                                default: true,
                                                type: "boolean"
                                            },
                                            display_on_screen_animation: {
                                                description: "Définit si l'effet doit être affiché en tant qu'animation à l'écran.",
                                                default: false,
                                                type: "boolean"
                                            }
                                        }
                            ...
                            properties: {
                                ...
                                random_time_choices: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            weight: {
                                                description: "Le poids de la valeur.",
                                                type: "number"
                                            },
                                            value: {
                                                description: "La valeur en secondes.",
                                                type: "number"
                                            }
                                        }
                                    }
                        ...
                        "minecraft:transformation": {
                            ...
                            properties: {
                                ...
                                delay: {
                                    ...
                                    properties: {
                                        block_assist_chance: {
                                            description: "Chance que l'entité cherche des blocs à proximité qui peuvent accélérer la transformation. La valeur doit être comprise entre 0,0 et 1,0.",
                                            default: 0.0,
                                            type: "number",
                                            minimum: 0.0,
                                            maximum: 1.0
                                        ...
                                        block_chance: {
                                            description: "Chance que, une fois un bloc trouvé, l'entité accélère la transformation.",
                                            default: 0.0,
                                            type: "number"
                                        },
                                        block_max: {
                                            description: "Nombre maximum de blocs que l'entité cherchera pour aider à la transformation. Si non défini ou défini à 0, il sera défini sur le rayon de blocs.",
                                            default: 0,
                                            type: "integer"
                                        },
                                        block_radius: {
                                            description: "Distance en blocs que l'entité cherchera des blocs qui peuvent aider à la transformation.",
                                            default: 0,
                                            type: "integer"
                                        },
                                        block_types: {
                                        ...
                                        range_max: {
                                            description: "Temps maximum en secondes à ajouter pour avoir le temps aléatoire maximum jusqu'à ce que l'entité se transforme (si non nul, le temps en secondes avant que l'entité se transforme sera un décimal aléatoire entre 'valeur+range_min' et 'valeur+range_max').",
                                            default: 0,
                                            type: "number"
                                        },
                                        range_min: {
                                            description: "Temps minimum en secondes à ajouter pour avoir le temps aléatoire minimum jusqu'à ce que l'entité se transforme (si non nul, le temps en secondes avant que l'entité se transforme sera un décimal aléatoire entre 'valeur+range_min' et 'valeur+range_max').",
                                            default: 0,
                                            type: "number"
                                        },
                                        value: {
                                            description: "Temps en secondes avant que l'entité se transforme.",
                                            default: 0,
                                            type: "number"
                                        }
                                    }
                        ...
                        "minecraft:behavior.admire_item": {
                            description: "Fait en sorte qu'une entité admire un objet qu'elle tient. Ce composant nécessite que le composant minecraft:admire_item soit défini dans la définition de l'entité.",
                            type: "object",
                            properties: {
                                admire_item_sound: {
                        ...
                        "minecraft:behavior.avoid_mob_type": {
                            ...
                            properties: {
                                ...
                                avoid_target_xz: {
                                    description: "La distance horizontale à laquelle l'entité doit s'éloigner de l'autre entité.",
                                    default: 16,
                                    type: "integer"
                                },
                                avoid_target_y: {
                                ...
                                entity_types: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            ...
                                            avoid_target_xz: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/avoid_target_xz"
                                            },
                                            avoid_target_y: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/avoid_target_y"
                                            },
                                            ignore_visibility: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/ignore_visibility"
                                            },
                                            max_dist: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/max_dist"
                                            },
                                            max_flee: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/max_flee"
                                            },
                                            on_escape_event: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/on_escape_event"
                                            },
                                            priority: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/priority"
                                            },
                                            probability_per_strength: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/probability_per_strength"
                                            },
                                            remove_target: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/remove_target"
                                            },
                                            sound_interval: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/sound_interval"
                                            },
                                            sprint_distance: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/sprint_distance"
                                            },
                                            sprint_speed_multiplier: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/sprint_speed_multiplier"
                                            },
                                            walk_speed_multiplier: {
                                                $ref: "#/properties/minecraft:entity/properties/components/properties/minecraft:behavior.avoid_mob_type/properties/walk_speed_multiplier"
                                            }
                                        }
                                    }
                                },
                        ...
                        "minecraft:behavior.barter": {
                            description: "Fait en sorte qu'une entité laisse tomber un item en retour après qu'un joueur ait offert un échange en déposant un objet spécifique près de l'entité. Ce composant nécessite que le composant minecraft:barter soit défini dans la définition de l'entité.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite ce comportement sera exécuté en tant qu'objectif.",
                        ...
                        "minecraft:behavior.breed": {
                            description: "Permet à l'entité de se reproduire avec d'autres entités de la même espèce. Nécessite que le composant minecraft:breedable soit défini dans la définition de l'entité.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite ce comportement sera exécuté en tant qu'objectif.",
                        ...
                        "minecraft:behavior.circle_around_anchor": {
                            ...
                            properties: {
                                ...
                                height_adjustment_chance: {
                                    description: "Pourcentage de chance de déterminer à quelle fréquence augmenter ou diminuer la hauteur actuelle autour du point d'ancrage. 1 = 100%. Note: La propriété suivante est obsolète `height_change_chance` a été remplacé par `height_adjustment_chance`.",
                                    default: 0.002857,
                                    type: "number"
                                },
                                height_offset_range: {
                                ...
                                radius_adjustment_chance: {
                                    description: "Pourcentage de chance de déterminer à quelle fréquence augmenter la taille du rayon de mouvement actuel autour du point d'ancrage. 1 = 100%. La propriété suivante est obsolète `radius_change_chance` a été remplacé par `radius_adjustment_chance`.",
                                    default: 0.004,
                                    type: "number"
                                },
                                radius_change: {
                        ...
                        "minecraft:behavior.defend_trusted_target": {
                            description: "Force l'Entité à réagir avec un événement lorsqu'une cible de confiance est attaquée. Ce composant nécessite que l'entité soit dans une relation de confiance avec une autre entité pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                aggro_sound: {
                                ...
                                entity_types: {
                                    ...
                                    properties: {
                                        cooldown: {
                                            description: "Le temps en secondes que l'entité doit attendre avant de pouvoir être selectionné comme cible à nouveau.",
                                            default: 0.0,
                                            type: "number"
                                        },
                                        filters: {
                                        ...
                                        reevaluate_description: {
                                            description: "Si vrai, l'entité sera réévaluée comme cible à chaque tick.",
                                            default: false,
                                            type: "boolean"
                                        },
                                        sprint_speed_multiplier: {
                        ...
                        "minecraft:behavior.dragonchargeplayer": {
                            description: "Force l'Entité à attaquer un joueur en chargeant vers lui. Ce composant nécessite que l'entité soit un Ender Dragon pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                active_speed: {
                        ...
                        "minecraft:behavior.dragondeath": {
                            description: "Contrôle le comportement de l'entité lorsqu'elle meurt. Ce composant nécessite que l'entité soit un Ender Dragon pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite ce comportement sera exécuté en tant qu'objectif.",
                        ...
                        "minecraft:behavior.dragonflaming": {
                            description: "Permet à l'entité d'utiliser une attaque de souffle de feu. Ce composant nécessite que l'entité soit un Ender Dragon pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                cooldown_time: {
                        ...
                        "minecraft:behavior.dragonholdingpattern": {
                            description: "Force l'Entité à voler en cercle autour du podium central situé dans The End. Ce composant nécessite que l'entité soit un Ender Dragon pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite ce comportement sera exécuté en tant qu'objectif.",
                        ...
                        "minecraft:behavior.dragonlanding": {
                            description: "Force l'Entité à atterrir. Ce composant nécessite que l'entité soit un Ender Dragon pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite ce comportement sera exécuté en tant qu'objectif.",
                        ...
                        "minecraft:behavior.dragonscanning": {
                            description: "Force l'Entité à scanner pour les joueurs. Ce composant nécessite que l'entité soit un Ender Dragon pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite ce comportement sera exécuté en tant qu'objectif.",
                        ...
                        "minecraft:behavior.dragonstrafeplayer": {
                            description: "Force l'Entité à attaquer un joueur en effectuant une attaque de strafe. Ce composant nécessite que l'entité soit un Ender Dragon pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                active_speed: {
                        ...
                        "minecraft:behavior.dragontakeoff": {
                            description: "Force l'Entité à décoller. Ce composant nécessite que l'entité soit un Ender Dragon pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite ce comportement sera exécuté en tant qu'objectif.",
                            ...
                            properties: {
                                potions: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            chance: {
                                                description: "La chance (de 0,0 à 1,0) que cette potion soit sélectionnée lors de la recherche d'une potion à utiliser.",
                                                default: 1.0,
                                                type: "number",
                                                minimum: 0.0,
                                                maximum: 1.0
                        ...
                        "minecraft:behavior.drop_item_for": {
                            description: "Force l'Entité à déposer un item pour une autre entité. Ce composant nécessite que l'entité ait un composant de navigation pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                cooldown: {
                        ...
                        "minecraft:behavior.eat_carried_item": {
                            description: "Force l'Entité à manger un item qu'elle transporte dans son inventaire. Il faut que les items soient dans l'inventaire de l'entité pour qu'elle puisse les manger.",
                            type: "object",
                            properties: {
                                delay_before_eating: {
                        ...
                        "minecraft:behavior.explore_outskirts": {
                            description: "Force l'Entité à explorer les points aléatoires à la périphérie du village. Ce composant nécessite que l'entité ait un composant de navigation et 'minecraft:dweller' pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                dist_from_boundary: {
                        ...
                        "minecraft:behavior.fertilize_farm_block": {
                            description: "Permet à l'Entité de chercher une zone pour fertiliser les cultures. Ce composant ne s'exécutera pas si l'entité n'a pas d'objet fertilisant dans son inventaire.",
                            type: "object",
                            properties: {
                                goal_radius: {
                        ...
                        "minecraft:behavior.fire_at_target": {
                            description: "Permet à l'Entité d'attaquer en tirant un coup avec un delai. Le point d'ancrage et le décalage de ce composant remplacent le point d'ancrage et le décalage du composant de projectile.",
                            type: "object",
                            properties: {
                                attack_cooldown: {
                        ...
                        "minecraft:behavior.float_wander": {
                            ...
                            properties: {
                                ...
                                surface_xz_dist: {
                                    description: "Distance horizontale (X et Z) à laquelle chercher une surface solide. Ne fonctionne que si `navigate_around_surface` est activé.",
                                    default: 0,
                                    type: "integer"
                                },
                                surface_y_dist: {
                                    description: "Distance verticale (Y) à laquelle chercher une surface solide. Ne fonctionne que si `navigate_around_surface` est activé.",
                                    default: 0,
                                    type: "integer"
                                },
                        ...
                        "minecraft:behavior.follow_caravan": {
                            ...
                            properties: {
                                ...
                                entity_types: {
                                    ...
                                    properties: {
                                        cooldown: {
                                            description: "Le temps en secondes que l'Entité doit attendre avant de sélectionner une nouvelle cible de la même entité.",
                                            default: 0.0,
                                            type: "number"
                                        },
                                        filters: {
                        ...
                        "minecraft:behavior.follow_parent": {
                            description: "Force une Entité à suivre son parent. Ce composant nécessitr que l'Entité ait le composant 'minecraft:is_baby' pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite cet objectif sera exécuté.",
                        ...
                        "minecraft:behavior.guardian_attack": {
                            description: "Permet à l'Entité d'utiliser une attaque de rayon laser. Ce composant ne s'exécutera pas si l'entité n'est pas un Gardien ou un Gardien Ancien.",
                            type: "object",
                            properties: {
                        ...
                        "minecraft:behavior.harvest_farm_block": {
                            description: "Force l'Entité à chercher dans une zone des blocs de farmland avec de l'air au dessus. Si trouvé, l'Entité remplacera le bloc d'air en plantant un item de graine de son inventaire sur le bloc de farmland. Cet objectif nécessite les composants 'minecraft:inventory' et 'minecraft:navigation' pour fonctionner. Cet objectif ne s'exécutera pas si l'entité n'a pas d'item dans son inventaire.",
                            type: "object",
                            properties: {
                                goal_radius: {
                        ...
                        "minecraft:behavior.hide": {
                            description: "Force une Entité avec le composant 'minecraft:hide' à tenter de se déplacer vers un point d'intérêt (POI) et à se cacher. Ce composant nécessite un point d'intérêt pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                duration: {
                        ...
                        "minecraft:behavior.hold_ground": {
                            description: "Force l'Entité à rester à sa position actuelle et à attaquer les entités qui s'approchent. Cet objectif nécessite une cible pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                broadcast: {
                        ...
                        "minecraft:behavior.knockback_roar": {
                            description: "Force une Entité à émettre un effet de rugissement qui repousse les autres Entités dans un rayon défini à partir de l'endroit où le rugissement a été émis. Ce composant nécessite un événement de déclenchement pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                attack_time: {
                        ...
                        "minecraft:behavior.leap_at_target": {
                            description: "Force l'Entité à sauter vers une cible. Cet objectif nécessite une cible pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                must_be_on_ground: {
                        ...
                        "minecraft:behavior.look_at_target": {
                            description: "Force une Entité à regarder une cible en tournant la pose de l'os de la tête dans une limite définie. Cet objectif nécessite une cible pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                angle_of_view_horizontal: {
                                    description: "L'angle en degrés que l'Entité peut voir dans l'axe X (gauche-droite).",
                        ...
                        "minecraft:behavior.move_towards_target": {
                            description: "Force une Entité à se déplacer vers une cible. Ce composant nécessite que l'Entité ait une cible.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "Plus la priorité est haute, plus vite cet objectif sera exécuté.",
                        ...
                        "minecraft:behavior.nearest_attackable_target": {
                            description: "Force une Entité à attaquer la cible la plus proche dans un sous-ensemble donné de types de cibles spécifiques. Ce composant est une nécessité pour le composant 'minecraft:behavior.melee_attack'.",
                            type: "object",
                            properties: {
                                attack_interval: {
                        ...
                        "minecraft:behavior.offer_flower": {
                            description: "Force une Entité à offrir une fleur à une autre entité. L'Entité doit avoir un item fleur.",
                            type: "object",
                            properties: {
                                priority: {
                        ...
                        "minecraft:behavior.place_block": {
                            description: "Permet à l'Entité de placer des blocs dans le monde.",
                            type: "object",
                            properties: {
                                affected_by_griefing_rule: {
                                    description: "Si vrai, l'entité respectera la règle de jeu 'mobGriefing' pour déterminer si elle peut placer des blocs.",
                                    type: "boolean"
                                },
                                can_place: {
                                    description: "Filtres pour définir si l'Entité devrait essayer de placer son bloc.",
                                    ...commonSchemas.minecraft_filter
                                },
                                chance: {
                                    description: "La chance en pourcentage que le mob place un bloc.",
                                    type: "number",
                                    minimum: 0.0,
                                    maximum: 1.0
                                },
                                on_place: {
                                    description: "L'événement à déclencher lorsque l'entité place un bloc.",
                                    oneOf: [
                                        {
                                            type: "string"
                                        },
                                ...
                                placeable_carried_blocks: {
                                    description: "Les blocs que l'Entité peut placer depuis sa main. Si vide, tous les blocs sont valides.",
                                    type: "array",
                                    items: {
                                        oneOf: [
                                            {
                                ...
                                randomly_placeable_blocks: {
                                    description: "Les blocs que l'Entité peut placer aléatoirement dans le monde. Si vide, l'entité essaiera de placer son bloc transporté depuis `placeable_carried_blocks`.",
                                    type: "array",
                                    items: {
                                        type: "object",
                                        properties: {
                                            ...
                                            filter: {
                                                description: "Filtres pour définir si l'Entité devrait essayer de placer ce bloc.",
                                                ...commonSchemas.minecraft_filter
                                            }
                                        }
                                    }
                        ...
                        "minecraft:behavior.play": {
                            description: "Force une Entité à jouer avec d'autres entités en se poursuivant et en se déplaçant aléatoirement. Utilisable que par les villageois.",
                            type: "object",
                            properties: {
                                chance_to_start: {
                        ...
                        "minecraft:behavior.receive_love": {
                            description: "Force une Entité à s'accoupler avec une autre entité similaire lorsqu'elle s'approche pour se reproduire. Ce comportement ne peut être utilisé que par le type d'entité villageois.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "La priorité de l'objectif.",
                            ...
                            properties: {
                                ...
                                sequence: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            base_delay: {
                                                description: "La durée en secondes avant de commencer cette étape.",
                                                default: 0.0,
                                                type: "number"
                                            },
                                            event: {
                                                description: "L'événement à envoyer.",
                                                type: "string"
                                            },
                                            sound_event: {
                                                description: "L'événement sonore à jouer lorsque cette étape se produit.",
                                                type: "string"
                                            }
                                        }
                                    }
                        ...
                        "minecraft:behavior.silverfish_merge_with_stone": {
                            description: "Force une Entité à entrer dans un bloc de pierre. Ce comportement ne peut être utilisé que par le type d'entité poisson d'argent.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "La priorité de l'objectif.",
                        ...
                        "minecraft:behavior.silverfish_wake_up_friends": {
                            description: "Force une Entité à alerter d'autres entités de la même famille pour sortir d'un bloc de pierre. Ce comportement ne peut être utilisé que par le type d'entité poisson d'argent. Ce comportement nécessite que `minecraft:behavior.silverfish_merge_with_stone` soit défini.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "La priorité de l'objectif.",
                        ...
                        "minecraft:behavior.sleep": {
                            description: "Force une Entité à dormir dans un lit. Ce comportement ne peut être utilisé que par le type d'entité villageois.",
                            type: "object",
                            properties: {
                        ...
                        "minecraft:behavior.slime_float": {
                            description: "Force une Entité à flotter dans l'eau ou la lave. Ce comportement ne peut être utilisé que par le type d'entité slime et cube de magma.",
                            type: "object",
                            properties: {
                        ...
                        "minecraft:behavior.squid_dive": {
                            description: "Force une Entité à plonger sous l'eau. Ce comportement ne peut être utilisé que par le type d'entité pieuvre.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "La priorité de l'objectif.",
                        ...
                        "minecraft:behavior.squid_flee": {
                            description: "Force une Entité à nager loin lorsqu'elle est attaquée. Ce comportement ne peut être utilisé que par le type d'entité pieuvre.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "La priorité de l'objectif.",
                        ...
                        "minecraft:behavior.squid_idle": {
                            description: "Force une Entité à nager sur place. Ce comportement ne peut être utilisé que par le type d'entité pieuvre.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "La priorité de l'objectif.",
                        ...
                        "minecraft:behavior.squid_move_away_from_ground": {
                            description: "Force une Entité à nager loin des blocs du sol. Ce comportement ne peut être utilisé que par le type d'entité pieuvre.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "La priorité de l'objectif.",
                        ...
                        "minecraft:behavior.squid_out_of_water": {
                            description: "Force une Entité à rester proche d'un bloc de sol lorsqu'elle est hors de l'eau. Ce comportement ne peut être utilisé que par le type d'entité pieuvre.",
                            type: "object",
                            properties: {
                                priority: {
                                    description: "La priorité de l'objectif.",
                        ...
                        "minecraft:behavior.stalk_and_pounce_on_target": {
                            description: "Force une Entité à traquer une cible spécifique. Une fois à portée de la cible, l'entité sautera sur la cible et infligera des dégâts en fonction de son attribut d'attaque. Ce comportement nécessite une cible pour fonctionner correctement et un attribut d'attaque pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                interest_time: {
                            ...
                            properties: {
                                ...
                                summon_choices: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            cast_duration: {
                                                description: "Temps en secondes que le lancer de sort prendra.",
                                                type: "number"
                                            },
                                            cooldown_time: {
                                                description: "Le temps en secondes que le mob doit attendre avant de pouvoir utiliser à nouveau ce sort.",
                                                default: 0.0,
                                                type: "number"
                                            },
                                            do_casting: {
                                                description: "Si vrai, le mob fera les animations de lancer et affichera des particules de sort.",
                                                default: true,
                                                type: "boolean"
                                            },
                                            filters: {
                                            ...
                                            min_activation_range: {
                                                description: "La limite inférieure de la distance d'activation en blocs pour ce sort, ne doit pas être négative.",
                                                default: 1.0,
                                                type: "number",
                                                minimum: 0
                                            },
                                            particle_color: {
                                                description: "La couleur des particules pour ce sort.",
                                                default: 0,
                                                type: "integer"
                                            },
                                            start_sound_event: {
                                                description: "L'événement sonore à jouer lorsque le sort est utilisé.",
                                                type: "string"
                                            },
                                            weight: {
                                                description: "Le poids de ce sort. Contrôle la probabilité que le mob choisisse ce sort lorsqu'il en lance un.",
                                                default: 0.0,
                                                type: "number"
                                            },
                                            sequence: {
                                                description: "Liste des étapes pour le sort.",
                                                type: "array",
                                                items: {
                                                    type: "object",
                                                    properties: {
                                                        base_delay: {
                                                            description: "La quantité de temps en secondes à attendre avant que cette étape ne commence.",
                                                            default: 0.0,
                                                            type: "number"
                                                        },
                                                        delay_per_summon: {
                                                            description: "La quantité de temps en secondes à attendre avant que chaque entité ne soit invoquée à cette étape.",
                                                            default: 0.0,
                                                            type: "number"
                                                        },
                                                        entity_lifespan: {
                                                            description: "La quantité de temps en secondes que l'entité invoquée restera en vie. Une valeur de -1,0 signifie qu'elle restera en vie aussi longtemps qu'elle le pourra.",
                                                            default: -1.0,
                                                            type: "number"
                                                        },
                                                        entity_type: {
                                                            description: "Le type d'entité des entités que nous invoquerons à cette étape.",
                                                            type: "string"
                                                        },
                                                        num_entities_spawned: {
                                                            description: "Le nombre d'entités qui seront invoquées à cette étape.",
                                                            default: 1,
                                                            type: "integer"
                                                        },
                                                        shape: {
                                                            description: "La forme de base de cette étape. Les valeurs valides sont 'circle' et 'line'.",
                                                            default: "line",
                                                            type: "string",
                                                            enum: ["circle", "line"]
                                                        },
                                                        size: {
                                                            description: "La taille de base de l'entité.",
                                                            default: 1.0,
                                                            type: "number"
                                                        },
                                                        sound_event: {
                                                            description: "L'événement sonore à jouer pour cette étape.",
                                                            type: "string"
                                                        },
                                                        summon_cap: {
                                                            description: "Nombre maximum d'entités invoquées à tout moment.",
                                                            default: 0,
                                                            type: "integer"
                                                        },
                                                        summon_cap_radius: {
                                                            description: "Le rayon maximum où les entités invoquées peuvent apparaître.",
                                                            default: 0.0,
                                                            type: "number"
                                                        },
                                                        summon_event: {
                                                            description: "L'événement à invoquer sur chaque entité invoquée lors de l'apparition.",
                                                            type: "string"
                                                        },
                                                        target: {
                                                            description: "La cible du sort. C'est ici que le sort commencera (la ligne commencera ici, le cercle sera centré ici).",
                                                            default: "self",
                                                            type: "string",
                                                            enum: ["self", "target"]
                                                        }
                        ...
                        "minecraft:behavior.swim_up_for_breath": {
                            description: "Force une Entité à nager vers la surface pour respirer lorsqu'elle est à court d'air. Ce comportement nécessite un composant 'minecraft:breathable' pour fonctionner correctement.",
                            type: "object",
                            properties: {
                                material_type: {
                        ...
                        "minecraft:behavior.take_block": {
                            description: "Permet à l'Entité de prendre des blocs dans le monde.",
                            type: "object",
                            properties: {
                                affected_by_griefing_rule: {
                                    description: "Si `true`, ce comportement respectera la Gamerule `mobgriefing`.",
                                    type: "boolean"
                                },
                                blocks: {
                                    description: "Les blocs qui peuvent être pris par cette Entité. Si vide, tous les blocs peuvent être pris.",
                                    type: "array",
                                    items: {
                                        oneOf: [
                                            {
                                ...
                                can_take: {
                                    description: "Filtres pour définir quand l'Entité peut prendre un bloc.",
                                    ...commonSchemas.minecraft_filter
                                },
                                chance: {
                                    description: "Probabilité par tick que l'Entité essaie et prenne un bloc.",
                                    type: "number",
                                    minimum: 0,
                                    maximum: 1
                                },
                                on_take: {
                                    description: "Événement à déclencher lorsque l'Entité prend un bloc.",
                                    oneOf: [
                                        {
                                            type: "string"
                                        },
                                ...
                                requires_line_of_sight: {
                                    description: "Si `true`, l'Entité doit avoir une ligne de vue vers le bloc qu'elle essaie de prendre.",
                                    type: "boolean"
                                },
                                xz_range: {
                                    description: "La distance en XZ à laquelle l'Entité peut rechercher des blocs à prendre.",
                                    oneOf: [
                                        {
                                            type: "integer"
                                        },
                                ...
                                y_range: {
                                    description: "La distance en Y à laquelle l'Entité peut rechercher des blocs à prendre.",
                                    oneOf: [
                                        {
                                            type: "integer"
                                        },
                        ...
                        "minecraft:behavior.transport_items": {
                            "x-experimental_options": [experimentalOptions.drop_3_2025],
                            ...
                            properties: {
                                allow_simultaneous_interaction: {
                                    description: "Définit si l'Entité est autorisée à intéragir simultanément avec un conteneur qu'une autre entuté non-joueur est également en train d'intéragir avec.",
                                    default: false,
                                    type: "boolean"
                                },
                                allowed_items: {
                                    description: "Liste d'items que l'Entité est autorisée à transporter. Si vide, tous les items sont autorisés. Si non-vide, `disallowed_items` doit être vide.",
                                    default: [],
                                    type: "array",
                                    items: {
                                        oneOf: [
                                ...
                                destination_container_types: {
                                    description: "Liste des blocs conteneurs dans lesquels l'Entité peut déposer des items. Par défaut, tous les conteneurs sont autorisés. Seuls les coffres, coffres de cuivres, boites de shulkers, et tonneaux sont autorisés pour le moment.",
                                    type: "array",
                                    items: {
                                        oneOf: [
                                            {
                                ...
                                disallowed_items: {
                                    description: "Liste d'items que l'Entité n'est pas autorisée à transporter. Si vide, tous les items sont autorisés. Si non-vide, `allowed_items` doit être vide.",
                                    default: [],
                                    type: "array",
                                    items: {
                                        oneOf: [
                                ...
                                idle_cooldown: {
                                    description: "Le temps en secondes que l'Entité doit attendre avant de réessayer de chercher des conteneurs après avoir fouillé tous les conteneurs possibles.",
                                    default: 20,
                                    type: "number"
                                },
                                interaction_time: {
                                    description: "Le temps en secondes que l'Entité passe à intéragir avec un conteneur.",
                                    default: 3.0,
                                    type: "number"
                                },
                                initial_cooldown: {
                                    description: "Temps en secondes que l'Entité doit attendre après être appatue ou après que ses objectifs disponibles ont changé (par exemple à cause d'une mise à jour de groupe de composants).",
                                    default: 0.0,
                                    type: "number"
                                },
                                max_stack_size: {
                                    description: "La taille maximale du stack que l'Entité peut transporter.",
                                    default: 16,
                                    type: "integer"
                                },
                                max_visited_containers: {
                                    description: "Nombre maximum de conteneurs que l'Entité peut fouiller avant de désactiver cet objectif et de réinitialiser les conteneurs fouillés. `0` définit un nombre illimité de conteneurs.",
                                    default: 16,
                                    type: "integer"
                                },
                                place_strategy: {
                                    description:
                                    "Définit le contenu du conteneur auquel l'objectif est autorisé à ajouter des items." +
                                    "\n\n- `any`: Ne met aucune restriction, permet le placement de l'item dans le conteneur tant qu'il y a de la place." +
                                    "\n\n- `with_matching`: Ne permet seulement le placement de l'item dans un conteneur ayant déjà au moins un stack d'item." +
                                    "\n\n- `with_matching_or_empty`: Ne permet le placement de l'item que dans un conteneur ayant déjà au moins un stack d'item, ou dans un conteneur vide.", 
                                    default: "any",
                                    type: "string",
                                    enum: ["any", "with_matching", "with_matching_or_empty"]
                                },
                                search_strategy: {
                                    description: "Définit si l'Entité doit chercher le conteneur le plus proche ou au hasard.",
                                    default: "random",
                                    type: "string",
                                    enum: ["nearest", "random"]
                                },
                                search_distance: {
                                    description: "Définit la distance horizontale et verticale maximale à laquelle l'Entité peut chercher des conteneurs.",
                                    default: [62, 32],
                                    type: "array",
                                    minItems: 2,
                                    maxItems: 2,
                                ...
                                source_container_types: {
                                    description: "Liste des blocs conteneurs desquels l'Entité peut prendre des items. Par défaut, tous les conteneurs sont autorisés. Seuls les coffres, coffres de cuivres, boites de shulkers, et tonneaux sont autorisés pour le moment.",
                                    type: "array",
                                    items: {
                                        oneOf: [
                                            {
        ...
        changes: [
            {
                ...
                value: {
                    ...
                    properties: {
                        ...
                        relative_range: {
                            description: "Définit si la plage des sous-capteurs est additive par rapport à la taille de l'entité. Additive signifie que la plage des sous-capteurs est ajoutée à la taille de l'entité.",
                            default: true,
                            type: "boolean"
                        },
                        subsensors: {
                            ...
                            items: {
                                ...
                                properties: {
                                    cooldown: {
                                        description: "De combien de secondes le sous-capteur doit attendre avant de pouvoir détecter à nouveau des entités. Une valeur négative signifie qu'aucun temps de recharge n'est utilisé.",
                                        default: -1,
                                        type: "number"
                                    },
                                    event: {
