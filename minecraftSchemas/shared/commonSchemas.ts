                ...
                },
                {
                    ...
                    properties: {
                        test: {
                            ...
                            type: "string",
                            enum: [
                                "has_component", "has_item_with_component", "has_property", "has_tag", "is_controlling_passenger_family", "is_family", "is_vehicle_family", "weather", "weather_at_position"
                            ]
                        },
                        subject: {
                            type: "string",
                ...
                },
                {
                    ...
                    properties: {
                        test: {
                            ...
                            type: "string",
                            enum: [
                                "has_container_open", "has_nametag", "has_ranged_weapon", "has_silk_touch", "has_target", "has_trade_supply", "in_caravan", "in_clouds", "in_contact_with_water", "in_lava", "in_nether", "in_overworld", "in_water", "in_water_or_rain", "is_avoiding_mobs", "is_baby", "is_bound_to_creaking_heart", "is_climbing", "is_daytime", "is_humid", "is_immobile", "is_in_same_vehicle", "is_in_village", "is_leashed", "is_leashed_to", "is_missing_health", "is_moving", "is_navigating", "is_owner", "is_panicking", "is_persistent", "is_raider", "is_riding", "is_riding_self", "is_sitting", "is_sleeping", "is_sneak_held", "is_sneaking", "is_snow_covered", "is_sprinting", "is_tamed", "is_target", "is_underground", "is_underwater", "is_visible", "is_waterlogged", "on_fire", "on_ground", "on_hot_block", "on_ladder", "surface_mob", "taking_fire_damage", "trusts", "was_last_hurt_by"
                            ]
                        },
                        subject: {
                            type: "string",
